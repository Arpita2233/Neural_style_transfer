...
import utils.model
print(utils.model.__file__)
print(Decoder)
decoder = Decoder()
print(list(decoder.state_dict().keys())[:5])
decoder= Decoder().to(device)
decoder.load_state_dict(torch.load(r"experiment\experiment\decoder_final.pth", map_location=torch.device("cpu")))
encoder.eval()
decoder.eval()
    ...
    if form.validate_on_submit():
        ...
        if content_filename and style_filename:
            ...
            try:
                ...
                result_filename = "stylized_" + os.path.basename(content_filename)

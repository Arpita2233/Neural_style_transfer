...
def parse_arguments():
    ...
    parser.add_argument('--content_dir',type=str,default='content_data',help='Location of the content dataset')

    parser.add_argument('--style_dir',type=str,default='style_data',help='Location of the style dataset')
...
def main():
    ...
    print("Number of Batches in Content_Dataset:", len(content_dataloader))
    print("Number of Batches in Style_Dataset:", len(style_dataloader))
